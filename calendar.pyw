...
year = now.year
month = now.month
back_b = Button(root, text='Назад', command=back)
back_b.grid(row=0, column=0, sticky=NSEW)
next_b = Button(root, text='Вперёд', command=next)
next_b.grid(row=0, column=6, sticky=NSEW)
